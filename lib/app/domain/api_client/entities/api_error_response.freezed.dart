...
abstract class $ApiErrorResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, int? status, int? code, String? message});
}
...
class _$ApiErrorResponseImpl implements _ApiErrorResponse {
  ...
  @override
  String toString() {
    return 'ApiErrorResponse(name: $name, status: $status, code: $code, message: $message)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, status, code, message);
